          ...
          <div class="card shadow mt-4 border-white">
            <div class="card-body">
              <div class="d-flex bd-highlight">
                <div class="me-auto p-2 bd-highlight my-2">
                  <h4>Produk Lain</h4>
                </div>
                      ...
                      <div class="owl-item">
                        <div class="card <?= ($data->status_jual == 0) ? 'border border-danger' : ''; ?>">
                          <a href="<?= base_url('pages/detail/' . $data->slug) ?>">
                            <img src="<?= $direktori->produk_direktori . $data->nama_file ?>" class="card-img-top" alt="...">
                          </a>
                          <div class="card-body">
              ...
              <div class="row g-2">
                <div class="col-lg-6">
                  <div class="product-image me-lg-3 me-0">
                    <a href="<?= base_url('pages/detail/' . $data['slug']) ?>">
                      <img src="<?= $direktori->produk_direktori . $data['nama_file'] ?>" class="img-fluid rounded thumb d-block m-auto">
                    </a>
                  </div>
                </div>
